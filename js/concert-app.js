...
var fourohfourInfo = "<img src='assets/sb.png' class='headlinerPic'><hr class='break'><h3 class='fourohfourTitle'>Sweater Beats</h3><hr class='break'><h3 class='fourohfourSub'>\"Just trying to make you feel something\"</h3><h5 class='fourohfourDescription'>The Philippines and suburban Maryland aren't exactly R&B or dance music hot beds, but they didn't need to be for Antonio<br> Cuna aka Sweater Beats to ingest both genres and spit out an exciting new hybrid, melding the sensuality of contemporary R&B with the immediacy of dance music.</h5>";
